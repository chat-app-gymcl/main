    ...
    <div class="max-width">
        ...
        <div class="design-credit">
            <span>
                ...
                $footer_text = sprintf( __( '<a href="%1$s" rel="nofollow">%2$s</a> by Compete Themes.', 'startup-blog' ), 'https://www.competethemes.com/startup-blog/', wp_get_theme( get_template() ) );
